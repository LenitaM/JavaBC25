...
public class Carros {
    ...
    Carros(String modelo, String marca, int ano, boolean ehFlex, int qtPortas, double consumo) {
        this.modelo = modelo;
        this.marca = marca;
        this.ano = ano;
        this.ehFlex = ehFlex;
    ...
    public static void main(String[] args) {
        Carros carro1 = new Carros("XY", "Ferrari", 2019, true, 4, 40);
        Carros carro2 = new Carros("Z", "Ford", 2000, false, 2, 50);
